...
/////////////////
const BotName = 'BION-Bot☄'; 
const instagram = 'https://instagram.com/bioonnnn'; 
const telegram = 'https://t.me/KORI51; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCHrbt2CLVY_NL2kRGd4PaAA';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@bioonnnn')
